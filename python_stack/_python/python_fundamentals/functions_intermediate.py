...
def randInt(min=0, max=100):
    ...
    return round(num)
    # return num
print(randInt(min=0,max=1))# random.random() returns a random floating number between 0.000 and 1.000
print(randInt(min=0 , max =1*50)) 	# random.random() * 50 returns a random floating number between 0.000 and 50.000
print(randInt(min=0 , max =1*25+1)) # random.random() * 25 + 10 returns a random floating number between 10.000 and 35.000	
